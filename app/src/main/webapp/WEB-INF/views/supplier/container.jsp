...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="resources/css/supplier/supplier.css" media="all" />                   
		<script type="text/javascript" src="resources/scripts/supplier/SK.supplier.js"></script>                 
